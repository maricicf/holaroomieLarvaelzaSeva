<template>
    ...
    <div v-if="props.transparency" class="container relative">
        <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
            <div class="md:col-span-5">
                <div class="relative">
                    <div class="p-5 shadow dark:shadow-gray-700 rounded-t-full bg-white dark:bg-slate-900">
                        <img src="../assets/images/hero.jpg" class="shadow-md rounded-t-full rounded-md" alt="">
                    </div>
                    <div class="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                        <a @click="toggle" data-type="youtube" data-id="yba7hPeTSjk"
                            class="lightbox size-20 rounded-full shadow-md dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-cyan-600 cursor-pointer">
            ...
            <div class="md:col-span-7">
                <div class="lg:ms-4">
                    ...
                    <div class="mt-4">
                        <a href="" class="btn bg-cyan-600 hover:bg-cyan-700 text-white rounded-md mt-3">Learn More
                        </a>
                    </div>
                </div>
            </div><!--end col-->
    ...
    <div v-else class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
        <div class="md:col-span-5">
            <div class="relative">
                ...
                <div class="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                    <a @click="toggle" data-type="youtube" data-id="yba7hPeTSjk"
                        class="lightbox size-20 rounded-full shadow-md dark:shadow-gyay-700 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-cyan-600 cursor-pointer">
                        <i class="mdi mdi-play inline-flex items-center justify-center text-2xl"></i>
                    </a>
                </div>
            </div>
