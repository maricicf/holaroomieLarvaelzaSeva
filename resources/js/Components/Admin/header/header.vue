    ...
    <div class="top-header">
        <div class="header-bar flex justify-between">
            <div class="flex items-center space-x-1">
                ...
                <a @click="handlerClick" id="close-sidebar"
            ...
            <ul class="list-none mb-0 space-x-1">
                ...
                <li class="dropdown inline-block relative">
                    <button ref="dropdownToggle" @click="dropdownOpen = !dropdownOpen"
                            ...
                            type="button">
                        <img src="/assets/images/flags/usa.png" class="h-6 w-6 rounded-md" alt="">
                    </button>
                    <!-- Dropdown menu -->
                    <div
                        class="dropdown-menu absolute end-0 m-0 mt-4 z-10 w-36 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow dark:shadow-gray-700"
                        v-show="dropdownOpen">
                        <ul class="list-none py-2 text-start">
                            <li class="my-1">
                                <a href=""
                                   class="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-cyan-600 dark:hover:text-white"><img
                                    src="/assets/images/flags/germany.png"
                                    class="h-6 w-6 rounded-md me-2 shadow dark:shadow-gray-700" alt=""> German</a>
                            </li>
                            <li class="my-1">
                                <a href=""
                                   class="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-cyan-600 dark:hover:text-white"><img
                                    src="/assets/images/flags/italy.png"
                                    class="h-6 w-6 rounded-md me-2 shadow dark:shadow-gray-700" alt=""> Italian</a>
                            </li>
                            <li class="my-1">
                                <a href=""
                                   class="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-cyan-600 dark:hover:text-white"><img
                                    src="/assets/images/flags/russia.png"
                                    class="h-6 w-6 rounded-md me-2 shadow dark:shadow-gray-700" alt=""> Russian</a>
                            </li>
                            <li class="my-1">
                                <a href=""
                                   class="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-cyan-600 dark:hover:text-white"><img
                                    src="/assets/images/flags/spain.png"
                                    class="h-6 w-6 rounded-md me-2 shadow dark:shadow-gray-700" alt=""> Spanish</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="dropdown inline-block relative">
                    <button ref="dropdownToggle2" @click="dropdownOpen2 = !dropdownOpen2"
                            class="dropdown-toggle h-8 w-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[20px] text-center bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 border border-gray-100 dark:border-gray-800 text-slate-900 dark:text-white rounded-md"
                            type="button">
                        <i data-feather="bell" class="h-4 w-4"></i>
                        <span
                            class="absolute top-0 end-0 flex items-center justify-center bg-red-600 text-white text-[10px] font-bold rounded-md w-2 h-2 after:content-[''] after:absolute after:h-2 after:w-2 after:bg-red-600 after:top-0 after:end-0 after:rounded-md after:animate-ping"></span>
                    </button>
                    <!-- Dropdown menu -->
                    <div
                        class="dropdown-menu absolute end-0 m-0 mt-4 z-10 w-64 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow dark:shadow-gray-700"
                            ...
                            <li>
                                <a href="#!" class="block font-medium py-1.5 px-4">
                                    <div class="flex items-center">
                                        <div
                                            class="h-10 w-10 rounded-md shadow shadow-cyan-600/10 dark:shadow-gray-700 bg-cyan-600/10 dark:bg-slate-800 text-cyan-600 dark:text-white flex items-center justify-center">
                            ...
                            <li>
                                <a href="#!" class="block font-medium py-1.5 px-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ms-2">
                                            <span class="text-[15px] font-medium block"><span class="font-semibold">One
                                                    Refund Request</span></span>
                ...
                <li class="dropdown inline-block relative">
                    <button ref="dropdownToggle3" @click="dropdownOpen3 = !dropdownOpen3"
                            class="dropdown-toggle items-center" type="button">
                        <span
                            class="h-8 w-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[20px] text-center bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 border border-gray-100 dark:border-gray-800 text-slate-900 dark:text-white rounded-md"><img
                    ...
                    <div
                        ...
                        <ul class="py-2 text-start">
                            <li>
                                <Link href="/profile"
                                      class="block py-1 px-4 dark:text-white/70 hover:text-cyan-600 dark:hover:text-white">
                                    <i
                                        class="mdi mdi-account-outline me-2"></i>Profile
                                </Link>
                            </li>
                            <li>
                                <Link href="/chat"
                                      class="block py-1 px-4 dark:text-white/70 hover:text-cyan-600 dark:hover:text-white">
                                    <i
                                        class="mdi mdi-chat-outline me-2"></i>Chat
                                </Link>
                            </li>
                            <li>
                                <Link href="/profile-setting"
                                      class="block py-1 px-4 dark:text-white/70 hover:text-cyan-600 dark:hover:text-white">
                                    <i
                                        class="mdi mdi-cog-outline me-2"></i>Settings
                                </Link>
                            </li>
                            ...
                            <li>
                                <Link href="/lock-screen"
                                      class="block py-1 px-4 dark:text-white/70 hover:text-cyan-600 dark:hover:text-white">
                                    <i
                                        class="mdi mdi-lock-outline me-2"></i>Lockscreen
                                </Link>
                            </li>
                            <li>
                                <Link href="/login"
                                      class="block py-1 px-4 dark:text-white/70 hover:text-cyan-600 dark:hover:text-white">
                                    <i
                                        class="mdi mdi-logout me-2"></i>Logout
                                </Link>
                            </li>
                        </ul>
                    </div>
...
const props = defineProps(['handlerClick']);

const clickOutside = vClickOutside.directive;
...
const handleClickOutside2 = function(event) {
    if (!this.$refs.dropdownToggle2.contains(event.target)) {
        this.dropdownOpen2 = false;
    }
};
const handleClickOutside3 = function(event) {
