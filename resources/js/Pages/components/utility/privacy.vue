                    ...
                    <div class="md:w-3/4">
                        <div class="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                            ...
                            <ul class="list-unstyled text-slate-400 mt-4">
                                <li v-for="item in information" :key="item" class="flex mt-2"><i class="uil uil-arrow-right text-blue-600 align-middle me-2"></i>{{item}}</li>
                            </ul>
                            ...
                            <div class="mt-8">
                                <a href="" class="btn bg-blue-600 hover:bg-blue-700 text-white rounded-md">Print</a>
                            </div>
                        </div>
                    </div><!--end -->
                </div><!--end grid-->
...
const information = ref(['Digital Marketing Solutions for Tomorrow', 'Our Talented & Experienced Marketing Agency', 'Create your own skin to match your brand', 'Digital Marketing Solutions for Tomorrow', 'Our Talented & Experienced Marketing Agency', 'Create your own skin to match your brand'])
</script>
