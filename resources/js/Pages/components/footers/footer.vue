    ...
    <footer class="relative bg-slate-900 dark:bg-slate-800 mt-24">
        <div class="container relative">
            <div class="grid grid-cols-1">
                <div class="relative py-16 pt-36">
                    <!-- Subscribe -->
                        ...
                        <!-- <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                                ...
                                <div class="subcribe-form z-1">
                                    <form class="relative max-w-lg md:ms-auto">
                                        ...
                                        <button type="submit"
                                            class="btn bg-blue-600 hover:bg-blue-700 text-white rounded-full">Subscribe</button>
                                    </form>
                                </div>
                            </div> -->
                        ...
                        <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px] -mt-24">
                            ...
                            <div class="lg:col-span-2 md:col-span-4">
                                ...
                                <ul class="list-none footer-list mt-6">
                                    <li v-for="item in company" :key="item" class="mt-[10px] first:mt-0"><router-link
                                            :to="item.link"
                                            class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out"><i
                                                class="uil uil-angle-right-b me-1"></i> {{ item.name }}</router-link>
                                    </li>
                                </ul>
                                <h5 class="tracking-[1px] text-gray-100 font-semibold mt-4">Services</h5>
                                <ul class="list-none footer-list mt-6">
                                    <li v-for="item in services" :key="item" class="mt-[10px] first:mt-0"><router-link
                                            :to="item.link"
                                            class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out"><i
                                                class="uil uil-angle-right-b me-1"></i> {{ item.name }}</router-link>
                                    </li>
                            ...
                            <div class="lg:col-span-3 md:col-span-4">
                                ...
                                <ul class="list-none footer-list mt-6">
                                    <li v-for="item in usefulls" :key="item" class="mt-[10px] first:mt-0"><router-link
                                            :to="item.link"
                                            class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out"><i
                                                class="uil uil-angle-right-b me-1"></i> {{ item.name }}</router-link>
                                    </li>
                            ...
                            <div class="lg:col-span-3 md:col-span-4">
                                ...
                                <div class="flex mt-6">
                                    <i data-feather="map-pin" class="size-5 text-blue-600 me-3"></i>
                                    <div class="">
                                        ...
                                        <a href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39206.002432144705!2d-95.4973981212445!3d29.709510002925988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c16de81f3ca5%3A0xf43e0b60ae539ac9!2sGerald+D.+Hines+Waterwall+Park!5e0!3m2!1sen!2sin!4v1566305861440!5m2!1sen!2sin"
                                            data-type="iframe"
                                            class="text-blue-600 hover:text-blue-700 duration-500 ease-in-out lightbox">View
                                            on Google map</a>
                                    </div>
                                </div>

                                <div class="flex mt-6">
                                    <i data-feather="mail" class="size-5 text-blue-600 me-3"></i>
                                    <div class="">
                                ...
                                <div class="flex mt-6">
                                    <i data-feather="phone" class="size-5 text-blue-600 me-3"></i>
                                    <div class="">
                ...
                <div class="grid md:grid-cols-2 items-center gap-6">
                    <div class="md:text-start text-center">
                        <p class="mb-0 text-gray-300">©
                            {{ date }} Hously. Design & Develop with <i class="mdi mdi-heart text-red-600"></i> by <a
